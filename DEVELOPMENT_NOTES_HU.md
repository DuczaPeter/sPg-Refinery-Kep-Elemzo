...
## R18 – fejlesztői handoff csomag

A publikus repo most már a működő alkalmazás mellett teljes fejlesztői folytatási csomagot is tartalmaz: `AGENTS.md`, `STATUS.md`, contributing útmutatók, architektúra, teszt/release gate, AI-handoff, 24 ground-truth eredmény manifest és statikus release-ellenőrző script. A private screenshot fixture-k továbbra sincsenek terjesztve.
