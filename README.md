...
A Standard V4.1 szerint jelenleg **BLOCKED** egyetlen REQUIRED gate miatt:

**LICENSE STATUS RESOLVED** — az eredeti sPg kód/dokumentáció projektlicencét a tulajdonos még nem választotta ki explicit.

Az AI nem választ licencet helyetted.
