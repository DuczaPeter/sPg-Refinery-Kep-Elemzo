...
A saját sPg alkalmazáskódhoz és projekt-dokumentációhoz jelenleg **nincs külön OSI open-source licenc kiválasztva**. A nyilvános GitHub repo ezért önmagában nem jelent automatikus újrafelhasználási engedélyt. Lásd [LICENSE.md](LICENSE.md).
