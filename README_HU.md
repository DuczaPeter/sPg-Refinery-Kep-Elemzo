...
A repository most már teljes fejlesztői handoffot is tartalmaz, hogy más ember vagy kódoló AI biztonságosan folytathassa a projektet:

- [`AGENTS.md`](AGENTS.md) — kötelező projektinvariánsok és tiltások
- [`STATUS.md`](STATUS.md) — aktuális baseline és validációs állapot
- [`CONTRIBUTING.md`](CONTRIBUTING.md) — közreműködési belépési pont
- [`DEVELOPMENT/CONTRIBUTING_HU.md`](DEVELOPMENT/CONTRIBUTING_HU.md) — részletes magyar fejlesztői útmutató
- [`DEVELOPMENT/ARCHITECTURE_HU.md`](DEVELOPMENT/ARCHITECTURE_HU.md) — technikai architektúra és fontos függvények
- [`DEVELOPMENT/TESTING_HU.md`](DEVELOPMENT/TESTING_HU.md) — tesztelés és release gate
- [`DEVELOPMENT/AI_HANDOFF_HU.md`](DEVELOPMENT/AI_HANDOFF_HU.md) — átadás új coding agentnek
- [`DEVELOPMENT/GROUND_TRUTH.csv`](DEVELOPMENT/GROUND_TRUTH.csv) — 24 kézzel ellenőrzött várt eredmény
- [`DEVELOPMENT/RELEASE_CHECKLIST.md`](DEVELOPMENT/RELEASE_CHECKLIST.md) — release ellenőrzőlista
- [`tools/verify_release.py`](tools/verify_release.py) — könnyű statikus ellenőrző script

A fejlesztési Star Citizen screenshotok és nyers runtime logok jogi/adatvédelmi okból nem részei a publikus repónak. A ground-truth manifest viszont megőrzi az elvárt eredményeket.
